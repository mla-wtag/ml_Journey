...
RSpec.describe Journal, type: :model do
  ...
  describe 'validations' do
    ...
    it 'validates presence of attributes' do
      ...
      is_expected.to validate_presence_of(:content).with_message(I18n.t('validations.presence'))
      is_expected.to validate_presence_of(:goals_today).with_message(I18n.t('validations.presence'))
      is_expected.to validate_presence_of(:goals_tomorrow).with_message(I18n.t('validations.presence'))
    end
